...
add wave -radix Hexadecimal -group "CC: CLK IF" /board/pcie_cc_top/CC/i_fofb_cc_top/clk_if/*

add wave -radix Hexadecimal -group "CC: TOP" /board/pcie_cc_top/CC/i_fofb_cc_top/*

add wave -radix Hexadecimal -group "CC: GTP IF" /board/pcie_cc_top/CC/i_fofb_cc_top/gtp_if_gen/gtp_if/*

add wave -radix Hexadecimal -group "CC: RX_LL_0" /board/pcie_cc_top/CC/i_fofb_cc_top/gtp_if_gen/gtp_if/gtp_lane_gen__0/lanes/rx_ll/*

add wave -radix Hexadecimal -group "CC: FOD" /board/pcie_cc_top/CC/i_fofb_cc_top/i_fofb_cc_fod/*

add wave -radix Hexadecimal -group "CC: FRAME CTRL" /board/pcie_cc_top/CC/i_fofb_cc_top/i_fofb_cc_frame_cntrl/*

add wave -radix Hexadecimal -group "CC_TESTER: TOP" /board/fofb_cc_top_tester/*

add wave -radix Hexadecimal -group "CC_TESTER: TX USRAPP" /board/fofb_cc_top_tester/tx_usrapp/*
