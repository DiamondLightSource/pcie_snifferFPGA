    ...
    casex({fmt, f_type})
      ...
      `PCI_EXP_MEM_WRITE64: begin
        ...
        if (payload == 1) begin
          ...
          for (_i = 16; _i < _frame_store_idx; _i = _i + 4) begin

            payload32 = {   txrx ? frame_store_tx[_i+0] : frame_store_rx[_i+0],
                            txrx ? frame_store_tx[_i+1] : frame_store_rx[_i+1],
                            txrx ? frame_store_tx[_i+2] : frame_store_rx[_i+2],
                            txrx ? frame_store_tx[_i+3] : frame_store_rx[_i+3]  };

            $fdisplay(_log_file_ptr, "\t 0x%h", payload32);
    ...
    reg  [3:0]  _rem;
      ...
      for (_i = 0; _i < _rem; _i = _i + 1) begin
        ...
        if (txrx) begin
          ...
          board.xilinx_pci_exp_4_lane_downstream_port.com_usrapp.frame_store_tx[board.xilinx_pci_exp_4_lane_downstream_port.com_usrapp.frame_store_tx_idx] = _byte;
          board.xilinx_pci_exp_4_lane_downstream_port.com_usrapp.frame_store_tx_idx = board.xilinx_pci_exp_4_lane_downstream_port.com_usrapp.frame_store_tx_idx + 1;

        end else begin

          board.xilinx_pci_exp_4_lane_downstream_port.com_usrapp.frame_store_rx[board.xilinx_pci_exp_4_lane_downstream_port.com_usrapp.frame_store_rx_idx] = _byte;
          board.xilinx_pci_exp_4_lane_downstream_port.com_usrapp.frame_store_rx_idx = board.xilinx_pci_exp_4_lane_downstream_port.com_usrapp.frame_store_rx_idx + 1;
        end
